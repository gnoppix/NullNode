...
echo "============================================"
echo "  NullNode Remote Server Test"
echo "============================================"
echo "  Bootstrap: $SEED"
echo "  Relay:     $RELAY"
echo ""
...
echo ""
echo "--- Application Layer (NullNode Client) ---"
...
echo -n "[9] nullnode status (custom URLs): "
...
echo -n "[10] nullnode read (WS connection): "
...
echo "    but the NullNode protocol needs investigation."
echo ""
